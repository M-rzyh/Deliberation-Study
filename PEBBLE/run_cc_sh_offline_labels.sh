...
OFFLINE_JOB_ID=${OFFLINE_JOB_ID:-4568316}
JOB_NAME=${JOB_NAME:-1k}
OFFLINE_LABELS_CSV=${OFFLINE_LABELS_CSV:-human_labels_${JOB_NAME}_s1_no_skip.csv}
SEED=${SEED:-12345}
OFFLINE_HUMAN_MAX_LABELS=${OFFLINE_HUMAN_MAX_LABELS:-756}
OFFLINE_CONTINUE_WITH_SYNTHETIC=${OFFLINE_CONTINUE_WITH_SYNTHETIC:-true}
MAX_FEEDBACK=${MAX_FEEDBACK:-1000}
...
export COMPARE_RUN_DIR="${SCRATCH}/compare_runs/pebble/cmput654/offline/${JOB_NAME}_${OFFLINE_JOB_ID}/1000"
mkdir -p "$COMPARE_RUN_DIR"
echo "COMPARE_RUN_DIR=$COMPARE_RUN_DIR"
