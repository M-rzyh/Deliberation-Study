...
# Time-weighted PEBBLE training: Lunar Lander human labels
# Compares against unweighted baseline: 4629164
...
export BPR_ENV="/scratch/marzii/envs/bpref39_clone"
...
# Converted labels (from convert_lunarlander_labels.py)
OFFLINE_QUERY_DIR="/home/marzii/cmput654/PEBBLE/logs/human_queries"
OFFLINE_JOB_ID="lunarlander_4624956"
OFFLINE_LABELS_CSV="human_labels_converted.csv"
SEED=${SEED:-12345}

export COMPARE_RUN_DIR="${SCRATCH}/compare_runs/pebble/lunarlander_human/tw_${STRATEGY}_${SLURM_JOB_ID}"
...
"$PYTHON_BIN" train_PEBBLE.py \
  ...
  label_margin=0.0 teacher_eps_equal=0.0 \
